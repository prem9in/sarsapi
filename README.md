# Search and Recommender System - API
...
| application.test.py                                          | Python module defining tests function. Super useful for debugging and running outside of Flask environment. <br />This module is also used to generate inverted_index and posting files offline/upfront, without API being invoked. |
...
File *application.test.py* has by default has the code to initiate *inverted index* creation and perform a search. Let's run this file in python
